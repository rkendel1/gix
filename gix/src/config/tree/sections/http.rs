...
mod key_impls {
    ...
    impl crate::config::tree::http::FollowRedirects {
        ...
        > {
            ...
            Ok(if value.as_bstr().as_bytes() == b"initial" {
                ...
                .map_err(|err| crate::config::key::GenericErrorWithValue::from_value(self, value).with_source(err))?
            {
                if value {
                    FollowRedirects::All
                } else {
    ...
    impl super::ExtraHeader {
        ...
        pub fn try_into_extra_header(
            &'static self,
            values: Vec<impl crate::config::tree::keys::IntoBString>,
    ...
    impl super::Version {
        ...
        > {
            ...
            Ok(match value.as_bstr().as_bytes() {
                ...
                _ => {
                    return Err(crate::config::key::GenericErrorWithValue::from_value(self, value));
                }
            })
        }
    }
    ...
    impl SslVersion {
        ...
        > {
            ...
            Ok(match value.as_bstr().as_bytes() {
                ...
                b"tlsv1.2" => TlsV1_2,
                b"tlsv1.3" => TlsV1_3,
                _ => return Err(crate::config::ssl_version::Error::from_value(self, value)),
            })
        }
    }
}
