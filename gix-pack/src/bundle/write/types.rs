...
pub struct Options {
    ...
    ///
    /// Defaults to [`Compression::BEST_SPEED`](gix_features::zlib::Compression::BEST_SPEED) - `git` compresses
    ...
    pub compression: gix_features::zlib::Compression,
}
...
impl Default for Options {
    ...
    fn default() -> Self {
        Options {
            ...
            compression: gix_features::zlib::Compression::BEST_SPEED,
        }
    }
}
